...
Login state is saved in this isolated directory and reused on later runs. The spawned browser window is closed automatically when the Agent run finishes.

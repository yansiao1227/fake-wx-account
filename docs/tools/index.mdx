...
<CardGroup cols={2}>
  ...
  <Card title="doubao_search - Doubao Search" icon="magnifying-glass" href="/tools/doubao-search">
    Preferred standalone real-time web search via Volcengine Doubao Search
  </Card>
  <Card title="baidu_ai_search - Intelligent Search" icon="sparkles" href="/tools/baidu-ai-search">
    Intelligent search draft + sources for the agent to compose; falls back to web_search when quota runs out
  </Card>
  <Card title="web_search - Web Search" icon="magnifying-glass" href="/tools/web-search">
    Search the internet for multi-source raw results
  </Card>
</CardGroup>

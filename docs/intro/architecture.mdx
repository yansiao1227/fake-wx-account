...
| **Channels** | Message channel layer for receiving and sending messages. Supports the Web Console, Weixin official interface, and WeChat Desktop with a unified protocol |

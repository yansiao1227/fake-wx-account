...
- `true`: the model thinks before answering across all channels. The Web Console displays the thinking process; WeChat channels hide it but still receive the improved answer.

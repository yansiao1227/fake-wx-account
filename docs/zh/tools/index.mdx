...
<CardGroup cols={2}>
  <Card title="doubao_search - 豆包搜索" icon="magnifying-glass" href="/zh/tools/doubao-search">
    优先使用的独立实时联网搜索（火山引擎豆包搜索）
  </Card>
  <Card title="baidu_ai_search - 智能搜索" icon="sparkles" href="/zh/tools/baidu-ai-search">
    智能搜索草稿+来源，由 Agent 汇总；额度用完退化为 web_search
  </Card>

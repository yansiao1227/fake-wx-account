...
const QR_PROVIDERS: Record<string, 'weixin'> = { weixin: 'weixin' }

// An icon component that takes a `size` prop.
type IconComponent = React.FC<{ size?: number }>

// Per-channel icon + accent color.
const CHANNEL_STYLE: Record<string, { Icon: IconComponent; color: string }> = {
  weixin: { Icon: MessageCircle, color: '#10b981' },
  wechat_desktop: { Icon: RadioTower, color: '#10b981' },
}
